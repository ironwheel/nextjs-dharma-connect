...
const Home = () => {
    ...
    const formatDomainForDisplay = (domain: string): string => {
        ...
        // e.g., "access-manager.slsupport.link" -> "access-manager"
    ...
    const buildColumnLabelsAndRowData = () => {
    ...
    const handleSearch = (searchValue: string) => {
        ...
        const [cl, rd] = buildColumnLabelsAndRowData();
        setColumnLabels(cl);
        setRowData(rd);
    };
    ...
    const handleSaveAuthRecord = async () => {
        try {
            ...
            toast.success('Auth record saved successfully');
            ...
            toast.error('Failed to save auth record');
        }
    };
            ...
            try {
                ...
                if (accessManagerPool && poolsArray.length > 0) {
                    eligibleStudents = studentsArray.filter(student => {
                        ...
                        return checkEligibility(accessManagerPool, student, 'access-manager', poolsArray);
                    });
                    ...
                    <div className="navbar-container">
                        <div className="navbar-left">
                            <div className="navbar-item">
                                <h2 style={{ color: 'white', margin: 0 }}>Access Manager</h2>
                            </div>
                        </div>
